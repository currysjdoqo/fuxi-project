...
def get_wrong_questions(subject_id: Optional[int] = None, db: Session = Depends(get_db)):
    ...
    for wq in wrong_questions:
        ...
        last_record = db.query(PracticeRecord)\
            .filter(PracticeRecord.question_id == wq.question_id)\
